...
@section('subcontent')
    ...
    <div class="grid grid-cols-12 gap-6 mt-5">
        <div class="intro-y col-span-12 lg:col-span-6">
            <form class="validate-form-student" action="{{ route('student-eschool-sedev-save', $slug) }}" method="post" enctype="multipart/form-data">
                @csrf
                <!-- BEGIN: Анги нэмэх -->
                <div class="intro-y box p-5">
                    ...
                    <div class="flex justify-end mt-4">
                        <a href="{{ route('student-eschool-sedev', $slug) }}" class="btn w-40 bg-theme-6 text-white ml-5">{{ __('site.cancel') }}</a> 
