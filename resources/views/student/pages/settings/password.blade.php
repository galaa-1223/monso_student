    ...
    <div class="grid grid-cols-12 gap-6">
            ...
            <div class="intro-y box mt-5">
                <div class="relative flex items-center p-5">
                    <div class="w-12 h-12 image-fit">
                        <img alt="{{ Str::substr($student->ovog, 0, 1) }}. {{ $student->ner }}" class="rounded-full" src="{{ ($user->image == null) ? asset('dist/images/Blank-avatar.png') : asset('uploads/students/thumbs/'.$user->image)}}">
                    </div>
                ...
                <div class="p-5 border-t border-gray-200 dark:border-dark-5">
                    <a class="flex items-center" href="{{route('student-settings')}}">
                        <i data-feather="activity" class="w-4 h-4 mr-2"></i> Хувийн мэдээлэл
                    </a>
                    <a class="flex items-center mt-5 text-theme-1 dark:text-theme-10 font-medium" href="{{route('student-settings-password')}}">
        ...
        <div class="col-span-12 lg:col-span-8 xxl:col-span-9">
            ...
            @endif
                ...
                @endif
            <form class="form-horizontal" method="POST" action="{{ route('student-settings-changepassword') }}">
            {{ csrf_field() }}
