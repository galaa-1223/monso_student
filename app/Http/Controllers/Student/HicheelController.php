...
class HicheelController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        switch ($request->input('action')) {
            case 'save':
                return redirect()->route('student-hicheel')->with('success', 'Хичээл амжилттай нэмэгдлээ!'); 
                break;
    ...
    public function delete(Request $request)
    {
        ...
        $member->delete();
        return redirect()->route('student-hicheel')->with('success', 'Хичээл амжилттай устгалаа!'); 
    }
}
